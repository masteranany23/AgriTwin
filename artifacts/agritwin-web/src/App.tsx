...
import { ArrowDownRight, BarChart3, ChevronRight, Leaf, Menu, MoveRight, Satellite, X } from 'lucide-react';
...
function Hero() {
  return (
    <section id="top" className="mx-auto max-w-[1280px] px-5 pb-16 pt-20 text-center sm:px-8 sm:pb-20 sm:pt-28 lg:px-12 lg:pt-32">
      <div className="reveal mx-auto max-w-[760px]">
        <p className="label-caps flex items-center justify-center gap-3 text-[#6b866b]"><span className="h-px w-8 bg-[#6b866b]" /> AGRICULTURAL DIGITAL TWIN <span className="h-px w-8 bg-[#6b866b]" /></p>
        <h1 className="mt-7 text-[clamp(2.7rem,6.2vw,5.35rem)] font-semibold leading-[.99] tracking-[-.075em] text-[#1b3022]">A Digital Twin for Every Field.</h1>
        <p className="mx-auto mt-8 max-w-[620px] text-[16px] leading-7 text-[#5e675f] sm:text-[18px]">AgriTwin combines physics-based crop simulation, real-world observations and sequential data assimilation to understand field conditions and forecast what happens next.</p>
      ...
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-12">
        <div className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end">
          <div>
            ...
            <h2 className="mt-3 text-2xl font-semibold tracking-[-.05em] text-[#1b3022] sm:text-3xl">Demonstration field</h2>
          </div>
  ...
  return (
    <section className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
      <div className="flex flex-col justify-between gap-4 border-b border-[#dfe3dc] pb-6 sm:flex-row sm:items-end">
        <div><p className="label-caps text-[#6b866b]">02 / FIELD STATUS</p><h2 className="mt-3 text-2xl font-semibold tracking-[-.05em] text-[#1b3022] sm:text-3xl">Field Status</h2></div>
        <p className="max-w-[320px] text-xs leading-5 text-[#788078]">Real-time state variables extracted from the assimilated simulation.</p>
      </div>
      <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <MetricCard label="Leaf Area Index" value={demoField.current.lai} note="Current canopy surface" accent="#68876c" />
        <MetricCard label="Soil Moisture" value={demoField.current.moisture} note="Volumetric water content" accent="#3b82f6" />
        <MetricCard label="Total Biomass" value={demoField.current.biomass} note="Above-ground estimate" accent="#d97706" />
    ...
    <section id="science" className="border-y border-[#e0e4dc] bg-[#f0f3ed] py-20 sm:py-28">
      <div className="mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-12">
        <div className="grid gap-12 lg:grid-cols-[.7fr_1.3fr] lg:gap-20">
          ...
          <h2 className="mt-5 max-w-[390px] text-3xl font-semibold leading-tight tracking-[-.06em] text-[#1b3022] sm:text-4xl">State assimilation</h2>
    ...
    <section id="trajectory" className="mx-auto max-w-[1280px] px-5 py-20 sm:px-8 sm:py-28 lg:px-12">
      <div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr] lg:gap-20">
        <div>
          ...
          <h2 className="mt-5 max-w-[360px] text-3xl font-semibold leading-tight tracking-[-.06em] text-[#1b3022] sm:text-4xl">Assimilated LAI trajectory</h2>
